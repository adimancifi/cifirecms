...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => $server_link.'/content/uploads/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |
    */
    'thumbs_upload_dir' => '/content/thumbs/',
    ...
    */
    ...
    'previewable_text_file_exts'              => array( 'txt' ),
    ...
    'ext_file'                                => array( 'txt', 'pdf', 'doc', 'docx', 'ppt', 'pptx', 'rtf', 'xls', 'xlsx', 'csv'), //Files
    ...
    *******************/
    ...
    'hidden_folders' => array('user', 'medium', 'favicon'),
    ...
    *******************/
    ...
    'fixed_path_from_filemanager'             => array( '../../../content/uploads/medium/' ), //fixed path of the image folder from the current position on upload folder
    ...
    'fixed_image_creation_width'              => array( $medium_width ), //width of image
    'fixed_image_creation_height'             => array( $medium_height ), //height of image
    /*
    #             $option:     0 / exact = defined size;
    #                          1 / portrait = keep aspect set height;
    #                          2 / landscape = keep aspect set width;
    ...
    */
    ...
    'relative_image_creation_width'           => array( $medium_width ), //width of image
    'relative_image_creation_height'          => array( $medium_height ), //height of image
    /*
     * $option:     0 / exact = defined size;
     *              1 / portrait = keep aspect set height;
     *              2 / landscape = keep aspect set width;
