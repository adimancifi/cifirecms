	...
	<div class="block">
		<div class="block-header">
			...
			<div class="pull-right">
				<a href="<?=admin_url($this->mod.'/add-new');?>" class="button btn-primary btn-sm"><i class="icon-add"></i> <?=lang_line('button_add_new');?></a>
			</div>
		</div>
		<div class="row">
					...
					<table id="DataTable" class="display responsive no-wrap table table-striped table-hover table-bordered table-content">
						...
						<thead>
							<tr>
								...
								<th><?=lang_line('table_category');?></th>
								<th>Status</th>
		...
		<div class="modal-content">
			<form id="form_delete" method="POST" accept-charset="utf-8">
				...
				<div class="modal-footer">
					<button type="submit" class="button btn-default text-danger submit_delete"><i class="fa fa-trash mr-2"></i><?=lang_line('button_yes');?></button>
