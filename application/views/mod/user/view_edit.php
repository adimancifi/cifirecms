...
<div class="content">
	...
	<div class="block">
		<div class="block-header">
			<h2><?=lang_line('mod_title_edit');?></h2>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-group row">
					...
					<div class="col-md-4">
						<input type="text" class="form-control" value="<?=$res_user['user_username'];?>" disabled>
					</div>
				</div>
				<!--/ username -->
				...
				<div class="form-group row">
					...
					<div class="col-md-4">
						<input type="text" class="form-control" value="<?=$res_user['user_email'];?>" disabled/>
					</div>
				</div>
				<!--/ email -->
				...
				<div class="form-group row">
					...
					<div class="col-md-4">
						<input type="password" name="input_password" class="form-control" placeholder="<?=lang_line('form_label_pass_placholder');?>">
						<input type="hidden" name="input_password2" value="<?=$res_user['user_password'];?>">
						<p><span class="text-danger">*</span> <small class="text-muted"> <?=lang_line('form_label_pass_placholder');?></small></p>
					</div>
				</div>
				<!--/ password -->
				...
				<div class="form-group row">
					...
					<div class="col-md-4">
						<input type="text" name="name" value="<?=trim(set_value('name')) != "" ? trim(set_value('name')) : $res_user['user_name'];?>" placeholder="ex: Your Name" class="form-control">
					</div>
				</div>
				<!--/ fullname -->
							...
							<div class="form-group mb-3 mb-md-2">
								...
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-check-input-styled" name="gender" value="M" <?=( $res_user['user_gender'] == 'M' ? 'checked' : '');?> data-fouc>
										Male
									</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<label class="form-check-label">
										<input type="radio" class="form-check-input-styled" name="gender" value="F" <?=( $res_user['user_gender'] == 'F' ? 'checked' : '');?> data-fouc>
										Female
									</label>
								</div>
							</div>
				...
				<div class="form-group row">
					...
					<div class="col-md-4">
						<input type="text" name="tlpn" value="<?=trim(set_value('tlpn')) != "" ? trim(set_value('tlpn')) : $res_user['user_tlpn'];?>" placeholder="+62 000-0000-0000" class="form-control">
					</div>
				</div>
				<!--/ Telephone -->
				...
				<div class="form-group row">
					...
					<div class="col-md-10">
						<textarea name="address" class="form-control"><?=trim(set_value('address')) != "" ? trim(set_value('address')) : $res_user['user_address'];?></textarea>
					</div>
				</div>
				<!--/ address -->
				...
				<div class="form-group row">
					...
					<div class="col-md-10">
						<textarea name="about" class="form-control"><?=trim(set_value('about')) != "" ? trim(set_value('about')) : $res_user['user_about'];?></textarea>
					</div>
				</div>
				<!--/ about -->
				...
				<!-- photo -->
				<div class="form-group row">
					<label class="col-form-label col-md-2"><?=lang_line('form_label_photo');?></label>
					<div class="col-md-3">
						<div class="mb-2"><img id="image-preview" src="<?=user_photo($res_user['user_photo']);?>" class="thumbnail us-avatar" style="width:100px;"></div>
				...
				<div class="form-group row">
					...
					<div class="col-md-10">
						<div class="form-check">
							<input class="form-check-input" type="checkbox" id="cActiveb" name="active" value="1" <?=( $res_user['user_active'] == 'Y' ? 'checked' : '' )?>>
