...
<div class="colright">
	...
	<div class="box hidden-xs">
		...
		<div class="box-advertising">
			<a href="#">
				<img alt="" src="<?=post_images('ads.jpg');?>" />
			</a>
		</div>
	</div>
	...
	<div class="box hidden-xs">
		<div class="tab-caption">
			<ul role="tablist">
				<li class="active">
					<a href="#tabPopular" role="tab" data-toggle="tab"><i class="fa fa-heart"></i> Populer</a>
				</li>
				<li>
					<a href="#tabLatest" role="tab" data-toggle="tab"><i class="fa fa-clock-o"></i> Terbaru</a>
				</li>
			</ul>
		</div>
