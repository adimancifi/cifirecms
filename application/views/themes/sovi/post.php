					...
					<div class="single-post nobottommargin">
										...
										if ( ! empty($result_post['tag']) ) {
											...
											foreach ($data_tags as $tag) {
												$resultTag = $this->CI->db->where('seotitle', $tag)->get('t_tag')->row_array();
													if ( !empty($resultTag['seotitle']) && !empty($tag) && $tag == $resultTag['seotitle'] ) {
						...
						<div class="post-navigation clearfix">
							<div class="col_half nobottommargin">
								<a href="<?php echo (empty($prev_post['url']?"":$prev_post['url']))?>" title="<?php echo $prev_post['title']?>" class="btn btn-light">&lArr; Previous Post</a>
							</div>
							<div class="col_half col_last tright nobottommargin">
								<a href="<?php echo (empty($next_post['url'])?"":$next_post['url'])?>" title="<?php echo (empty($next_post['title'])?"":$next_post['title'])?>" class="btn btn-light">Next Post &rArr;</a>
							</div>
						</div>
						<!--/ Post Navigation -->
