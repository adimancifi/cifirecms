...
<?=form_open('', 'id="form-login" class="login-form" autocomplete="on"');?>
	...
	<div class="card mb-0">
		<div class="card-body">
			...
			<button type="submit" class="button btn-primary btn-block mt-3"><?=lang_line('button_send')?> <i class="fa fa-paper-plane ml-2"></i></button> </div>
			<div class="text-center mt-1 mb-3">
				<a href="<?=admin_url()?>" class="text-default"><i class="fa fa-arrow-circle-o-left"></i> <?=lang_line('button_back_to_login')?></a>
			</div>
		</div>
	</div>
	<p class="mt-3 text-center login-copyright">Copyright &copy; <?=$this->settings->website('web_name');?>  <?=date('Y');?>. MIT License</p>
<?=form_close();?>