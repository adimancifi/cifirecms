...
<body class="navbar-top">
		...
		<div  class="sidebar sidebar-dark sidebar-lightX sidebar-main sidebar-expand-md">
			...
			<div class="sidebar-content">
				<div class="card card-sidebar-mobile">
					<?php 
						$loginlevel = login_level('admin', true);
						$menu_group = dashboard_menu_active($loginlevel);
	...
	<script src="<?=content_url('plugins/bootstrap-multiselect/bootstrap-multiselect.js')?>"></script>
	<!-- DataTables js-->
	...
	<script src="<?=content_url('plugins/uploaders/purify.min.js');?>"></script>
	...
	<script src="<?=content_url('plugins/dashboard/js/custom.js')?>"></script>
	<!--/ dashboard app -->
