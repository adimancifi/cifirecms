...
/**
 * - Fungsi untuk mengambil data thema yang aktif.
...
/**
 * - Fungsi untuk pergantian bahasa.
 ...
 *  Hasil  : http://your.domain/admin/home
 * 
 * @param   string  $param
 ...
 * - Hasil  : http://your.domain/member/profile
 * 
 * @param   string  $param
 * @param   string  $protocol
 * @return  string  
...
/**
 * - Fungsi untuk menampilkan url ke folder content
 * 
 *  Contoh : <?=content_url('assets/foo/bar.css')?>
 *  Hasil  : http://your.domain/content/asset/foo/bar.css
 * 
 * @param   string  $param
 * @param   string	$protocol
 * @return  string  
 ...
 *   sesuai konfigurasi slug url pada data base t_seting.
 * 
...
/**
 * - Fungsi untuk menampilkan url favicon dan url gambar logo.
 * 
 ...
 *   Hasil  : http://your.dmoain/content/uploads/medium/medium_filename.jpeg
 * 
...
function post_images($filename = '', $mode = NULL, $noimage = FALSE)
{
	...
	switch ($noimage) 
	{
		...
		default:
		case FALSE:
			if ( !empty($filename) && $mode == '' ) 
				$image_url = content_url("uploads/$filename" );
			elseif ( !empty($filename) && $mode == 'medium' ) 
				$image_url = content_url("uploads/medium/$filename");
			elseif ( !empty($filename) && $mode == 'thumb' ) 
				$image_url = content_url("thumbs/$filename");
			else
				$image_url = content_url("images/noimage.jpg");
		break;
...
{
	if ( !empty($photo) && file_exists(FCPATH."content/uploads/user/$photo") ) 
...
/**
 * - Fungsi untuk memotong karakter dari paragraf kalimat.
 * 
...
/**
 * - Fungsi untuk kenversi array ke string.
 * 
...
/**
 * - Fungsi untuk kenversi data json ke array asosiatif.
 * 
